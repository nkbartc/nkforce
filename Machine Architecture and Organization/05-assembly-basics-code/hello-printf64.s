...
### > gcc -static hello-printf64.s
### > a.out
### 
### WITH GCC: Dynamically linked executable
### > gcc -no-pie hello-printf64.s
### > a.out
### 
### MANUALLY WITH LOW-LEVEL tools
### ASSEMBLE: Use GNU Assembler (as) to generate binary
### > as -o hello-printf64.o hello-printf64.s
### LINK: Complex as the standard C library must be linked manually which involves several files
### > ld -o hello -dynamic-linker /lib/ld-linux-x86-64.so.2 /usr/lib/crt1.o /usr/lib/crti.o /usr/lib/libc.so hello-printf64.o /usr/lib/crtn.o
### RUN:
### > ./hello
